"""Creates a game-ready weapon-upgrade crystal with three LOD meshes.

Usage:
  blender --background --python Tools/Blender/extract_weapon_crystal.py -- <source.fbx> <output-directory>
"""
